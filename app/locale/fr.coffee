...
#    snippets: "Snippets"
  ...
  premium_features:
    ...
    master_coder: "Deviens un maître du code en t'abonnant aujourd'hui !"
    paypal_redirect: "Tu seras redirigé vers PayPal pour compléter le processus d'abonnement."
    subscribe_now: "Abonne-toi Maintenant"
    ...
    hero_blurb_2: "Les Guerriers Premium débloquent d'impressionnantes capacités partiales comme le cri de guerre, le piétinement, et le lancer d'ennemi. Ou, joue un ranger en utilisant la discrétion, et des arcs, le lancer de couteaux, et les pièges ! Essaie tes pouvoirs en tant que vrai magicien du code, et libère une puissante magie primordiale, nécromancienne, ou élémentaire !"
    hero_caption: "De nouveaux héros impressionnants !"
    pet_blurb_1: "Les animaux de compagnie ne sont pas juste d'adorables compagnons, ils fournissent aussi d'uniques fonctionnalités et méthodes. Le bébé griffon peut transporter des unités dans les airs, le louveteau joue en attrapant les flèches des ennemis, le cougar adore chasser les ogres aux alentours, et le singe attire les pièces comme un aimant !"
    pet_blurb_2: "Collectionne tous les animaux de compagnie pour découvrir leurs capacités uniques !"
    pet_caption: "Adopte des animaux de compagnie pour accompagner tes héros !"
    game_dev_blurb: "Apprends le scripting de jeu et construis de nouveaux niveaux à partager avec tes amis ! Place les eléments que tu veux, écris du code pour ajouter une logique et un comportement aux unités créées, et vois si tes amis peuvent battre ce niveau !"
    ...
    list_web_dev: "Construis des sites web et des applications interactives"
    list_items: "Equipe-toi d'éléments exclusifs à l'abonnement Premium comme des animaux de compagnie"
    list_support: "Aie accès au support Premium pour t'aider à décortiquer du code difficile"
    list_clans: "Crée des clans privés pour inviter tes amis et effectue des compétitions de groupe via un tableau de bord"
  ...
  choose_hero:
    ...
    attack_1: "Inflige"
    attack_2: "Classé de"
    attack_3: "Dégâts causés par l'arme"
    health_1: "Gains"
